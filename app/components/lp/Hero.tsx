        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-start text-white">
          ...
          <div className="absolute bottom-8 left-8 flex gap-4">
            <div className="flex flex-col items-center">
              ...
              <span className="text-sm font-medium text-white text-center mt-1 bg-black/50 px-2 py-1 rounded">電話予約</span>
            </div>
          ...
          {/* デスクトップ用おすすめプランカード */}
          <div className="absolute bottom-8 right-8 max-w-xs bg-white rounded-xl shadow-lg p-4 relative">
            <div className="absolute -top-3 left-4 bg-primary text-white px-3 py-1 text-sm font-bold rounded-full">
              当店のおすすめ
            </div>
            <div 
